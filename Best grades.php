<?php 
    ...
    stagiaire.numeroInscription,
    stagiaire.nom,
    stagiaire.prenom,
    stagiaire.DateInscription,
    stagiaire.PhotoProfil,
    stagiaire.email,
    MAX(passerexam.note) AS note,
    stagiaire.idFiliere
    FROM 
        passerexam
    INNER JOIN 
        stagiaire
    ON 
        passerexam.numeroInscription = stagiaire.numeroInscription
    GROUP BY 
        stagiaire.idFiliere;
");
    $rq->execute();
    ...
    $reqste=$connexion->prepare("SELECT administrateur.nom,administrateur.prenom,administrateur.Photoprofil,administrateur.matricule_Admin FROM Compte
