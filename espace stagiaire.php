<?php 
    ...
    $reqe=$connexion->prepare("SELECT stagiaire.nom,stagiaire.prenom,stagiaire.PhotoProfil,stagiaire.idFiliere FROM Compte
...
<!--  -->
            ...
            <div class="dflex menu-items">
                ...
                <div class="relative profile0">
                    ...
                    <div class="dflex profile">
                        <img class="profile-img img0" src="<?php echo 'Users/' . $data['PhotoProfil']; ?>" alt="profile">
                        <div>
                            <div><?php echo $_SESSION['nom'] . " " . $_SESSION['prenom'] ?></div>
                            <div style="color:#18A3B7;" class="role">Trainee</div>
                        </div>
                        <img class="profile-img img1" src="<?php echo 'Users/' . $data['PhotoProfil']; ?>" alt="profile">
                    </div>
    ...
    <?php 
        echo"<h1>".bonjour_bonsoir()." ".$_SESSION['nom']." ".$_SESSION['prenom']." dans votre espace </h1>";
    ?>
