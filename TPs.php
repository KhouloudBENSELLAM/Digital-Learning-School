...
session_start();
    ...
    $coursWeb=$connexion->prepare("
        SELECT cours.titre, cours.sigle, resources.type, resources.url, cours.description, cours.Image_cours
        FROM cours 
        INNER JOIN resources ON cours.idcours = resources.idcours 
        WHERE resources.type = 'tp'
    ");
    $coursWeb->execute();

    
    $coursesBySigle = [];
    while ($data = $coursWeb->fetch()) {
...
<div style="margin-top:1px;">
        <div class="navbarr">
            ...
            <div class="dflex menu-items">
                ...
                <div class="relative profile0">
                    ...
                    <!-- <li><a href="show_Stg_Info.php" class="first">Show my informations</a></li>
                     <li><a href="edit_Stg_Info.php.php" class="dropdown-item">Edit my informations</a></li>
                     <li><a href="editpassword Admin.php" class="dropdown-item">Modifay Password</a></li>
                     <li><a href="editpassword Admin.php" class="dropdown-item">Log Out</a></li> -->
                </div>
            </div>
        </div>
    ...
    <?php foreach ($coursesBySigle as $sigle => $courses): ?>
        <h1>TP of modul <?php echo $sigle; ?></h1>
        <main>
            <div class="slider">
