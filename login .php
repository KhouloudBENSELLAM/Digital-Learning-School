...
<head>
    ...
    #darkmode-toggle:checked + #toggle + .background{
        background:#242424;
        
    }
    #darkmode-toggle:checked + #toggle ,.toggle-btn span{
        background: white;
    }
    #toggle svg {
        position: absolute;
    ...
    #darkmode-toggle:checked + #toggle svg.sun {
        fill:#7e7e7e;
    }
    #darkmode-toggle:checked + #toggle svg.moon {
        fill:#fff;
    }
...
<body >
    ...
    <section>
        ...
        <label for="darkmode-toggle" id="toggle">
    ...
    <aside>
    <article>
        <img src="images/project pic.webp" alt="">
    </article>
     <div class="wrapper">
      <form action="loginAction.php" >
        ...
        <div class="input-box">
            <input type="Password" placeholder="password" name="mp">
