...
<div class="container">
    <table class="table text-center">
        <thead>
            <tr>
                <th>Registration Number of Trainer</th>
                <th>Last Name</th>
                <th>First Name</th>
                <th>HireDate</th>
                <th>Picture</th>
        ...
        <tbody>
            <?php foreach ($formateurs as $ligne){ ?>
                <tr>
                    <td><?php echo $ligne['matricule_formateur']; ?></td>
                    ...
                    <td>
                        <a href="showinfoFormateur.php?id=<?php echo $ligne['matricule_formateur']; ?>"><img src="icons/show.png" alt="" width="20px" height="20px"></a>
                        <a href="modifierFormateur.php?MF=<?php echo $ligne['matricule_formateur']; ?>" style="margin-left:3%;"><img src="icons/edit.png" alt="" width="20px" height="20px" ></a>
                        <a href="supprimerFormateur.php?MTF=<?php echo $ligne['matricule_formateur']; ?>" style="margin-left:3%;" onclick="return confirm('Are you sure !?')"><img src="icons/bin.png" alt="" width="20px" height="20px"></a>
                    </td>
